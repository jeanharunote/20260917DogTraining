...
3. **키 확인하기** 버튼을 누르면 그 키가 쓸 수 있는 키인지 즉시 알려줍니다.
   (글을 생성하지 않고 확인만 하므로 사용량이 들지 않습니다.)
   - 키가 안 보여 불안하면 **키 보기** 를 눌러 붙여넣은 값을 직접 확인할 수 있습니다.
   - 공백이나 따옴표가 섞여 있으면 따로 알려줍니다.
4. 키·체중·러닝 경험 등을 입력하고 버튼을 누르면 결과가 나옵니다.
